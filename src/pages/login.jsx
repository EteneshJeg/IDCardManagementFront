							...
							<div className="w-lg-500px p-10">
								...
								<form className="form w-100" noValidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo1/dist/index.html" action="#">
									...
									<div className="fv-row mb-8">
										{/*begin::Email*/}
										<input type="text" placeholder={t('email')} name="email" autoComplete="off" className="form-control bg-transparent" onChange={(e) => setFormData({ ...formData, email: e.target.value })} />
										{/*end::Email*/}
									</div>
									{/*end::Input group=*/}
									<div className="fv-row mb-3">
										{/*begin::Password*/}
										<input type="password" placeholder={t('password')} name="password" autoComplete="off" className="form-control bg-transparent" onChange={(e) => setFormData({ ...formData, password: e.target.value })} />
										{/*end::Password*/}
									</div>
									{/*end::Input group=*/}
									{/*begin::Wrapper*/}
