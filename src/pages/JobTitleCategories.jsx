...
export default function JobTitleCategories() {
  ...
  useEffect(() => {
    console.log("Fetched categories from Redux:", jobTitleCategories);
  ...
  const handleSaveCategory = async () => {
    ...
    try {
    const result = await dispatch(addJobTitleCategory(formData)).unwrap();
    console.log("Add category result:", result); // Add this line
    toast.success("Category added successfully!");
    setIsModalOpen(false);
    setFormData({ name: '', description: '', parent: null });
    dispatch(fetchJobTitleCategories());
  } catch (error) {
    console.error("Add category error:", error); // Add this line
  ...
  const handleUpdateCategory = async () => {
    ...
    try {
        await dispatch(updateJobTitleCategory({
                      ...
                      <tr key={category.id}>
                        ...
                        <td>
                          {typeof category.parent === 'object' && category.parent !== null
                            ...
                            : categoryData.find(c => c.id === category.parent)?.name || 'None'}
                        </td>
