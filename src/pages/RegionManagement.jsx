...
export default function Region(){
  ...
  if (selectedFilter === "show all") {
    ...
    const totalPages=Math.ceil(regionData.length/itemsPerPage);
       ...
       const currentdata=Array.isArray(regionData)?regionData.slice(firstItemIndex,lastItemIndex):[regionData].slice(firstItemIndex,lastItemIndex);
    ...
    : "hide"
              ...
              {isModalOpen && (
                ...
                >
                  ...
                  <fieldset>
                      <legend className="text-start">Region Details</legend>
                          <form className="p-5 bg-white rounded shadow-sm text-start">
                            <div className="row g-4">
                               <div className="col-md-6">
                                  <label className="form-label fw-semibold required">Region name</label>
                                  <input type="text"
                              ...
                              <br/>
                              <div className="col-md-6">
                                  <label className="form-label fw-semibold required">Region Code</label>
                                  <input type="text" 
                                  className="form-control" 
                                  name="code" 
                                  onChange={(e)=>handleChange(e)} 
                                  required 
                                  placeholder="Region Code"></input>
                              </div>
                            </div>
                ...
                <div className="card card-flush h-xl-100">
                    ...
                    <div className="card-header pt-7">
                        ...
                        <h3 className="card-title align-items-start flex-column">
                            <span className="card-label fw-bold text-gray-800">Regions table</span>
                        </h3>
                                              ...
                                              <div className="modal-dialog">
                                                <div className="modal-content">
                                                  ...
                                                  <div className="modal-footer">
                                                    ...
                                                    <button type="button" className="btn btn-primary" onClick={()=>handleUpdateRegion(selectedUser.id)}>
                                                      Save changes
                                                    </button>
                                                  </div>
                                                </div>
