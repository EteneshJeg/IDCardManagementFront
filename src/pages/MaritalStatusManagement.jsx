...
export default function MaritalStatus(){
  ...
  <input
  type="checkbox"
  checked={Object.keys(selectedUsers).length === maritalStatusData.length}
  onChange={handleSelectAll}
  title={Object.keys(selectedUsers).length === maritalStatusData.length ? 'Deselect All' : 'Select All'}
